...
<!--    检查是否登陆过-->
    ...
    if(!isset($_SESSION['username'])) {
        echo "<script>alert('您没有权限，请先登陆！');window.location.href=\"index.html\"</script>";
    }
    ?>
<!--    按键调用ajax 调用php-->
    <script>
...
<div class="header bg-main">
    <div class="logo margin-big-left fadein-top">
        <h1 class="txtHeader"><img src="images/h3.jpg" onclick="changeHeadImg()" class="radius-circle rotate-hover" height="50" alt="" id="flush_head" />用户新闻管理中心</h1>
    </div>
    <div class="head-l">
        <a class="button button-little bg-green" href="../show/show.html" onclick="Logout()"><span class="icon-home"></span> 前台首页</a> &nbsp;&nbsp;
        <a class="button button-little bg-red" href="index.html" onclick="Logout()" ><span class="icon-power-off"></span> 退出登录</a>
        <label>当前用户：</label>
...
<div class="leftnav">
    ...
    <ul style="display:block">
        ...
        <li><a href="updateUsers.html" target="right"><span class="icon-caret-right"></span>修改用户信息</a></li>
